...
<div class="row mb-4">
    <div class="col">
        <div class="btn-group" role="group">
            <button class="btn btn-sm btn-outline-primary">Tous les logs</button>
            <button class="btn btn-sm btn-outline-primary">Erreurs</button>
            <button class="btn btn-sm btn-outline-primary">Accès</button>
            <button class="btn btn-sm btn-outline-primary">Modifications</button>
        </div>
    </div>
